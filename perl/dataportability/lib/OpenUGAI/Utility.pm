...
sub getSimpleResult {
	my ($sql, @args) = @_;
	my $dbh = &DBHandler::getConnection($OpenUGAI::Config::DSN, $OpenUGAI::Config::DBUSER, $OpenUGAI::Config::DBPASS);
...
sub HttpPostRequest {
	...
	print SOCK "Content-Type: text/xml$CRLF"; # necessary for POST XML data
