...
sub _login_to_simulator {
    ...
    return &OpenUGAI::Utility::XMLRPCCall($url, "login_to_simulator", \%xml_rpc_param);
}
...
sub _get_user_by_name {
    ...
    return &OpenUGAI::Utility::XMLRPCCall($url, "get_user_by_name", \%xml_rpc_param);
}
...
sub _get_user_by_uuid {
    ...
    return &OpenUGAI::Utility::XMLRPCCall($url, "get_user_by_uuid", \%xml_rpc_param);
}
