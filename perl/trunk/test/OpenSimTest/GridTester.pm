...
sub _simulator_login {
    ...
    return &OpenUGAI::Utility::XMLRPCCall($url, "simulator_login", \%xml_rpc_param);
}
...
sub _map_block {
    ...
    return &OpenUGAI::Utility::XMLRPCCall($url, "map_block", \%xml_rpc_param);
}
...
sub _simulator_data_request {
    ...
    return &OpenUGAI::Utility::XMLRPCCall($url, "simulator_data_request", \%xml_rpc_param);
}
...
sub _simulator_after_region_moved {
    ...
    return &OpenUGAI::Utility::XMLRPCCall($url, "simulator_after_region_moved", \%xml_rpc_param);
}
